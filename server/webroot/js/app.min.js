...
var _class = __webpack_require__(328);
...
{
	var _obj = { name: 'jacecao_test', age: '27' };

	var _Persion = function () {
		function _Persion() {
			_classCallCheck(this, _Persion);

			Object.assign(this, _obj);
		}

		_createClass(_Persion, [{
			key: 'say',
			value: function say() {
				return this.name;
			}
